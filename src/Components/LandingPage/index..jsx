        ...
        <div className="mx-5  ">
            <div className="grid md:grid-cols-2 lg:mx-10 mx-5">
                <div className="lg:mt-20 mt-10">
                    ...
                    <Link to={"/signup"}>
                        <button type="button" className="text-white py-4 px-8 mt-4 bg-background hover:bg-[#9370DB] hover:text-white rounded-[10px]">Get Started</button>
                    </Link>
                </div>
                <div>
            ...
            {/* cards */}
            <div className="grid md:grid-cols-3 grid-cols-2 gap-9 mx-0 mt-5">
                <div className="bg-[#8763CD]/25 shadow-lg p-5 backdrop-blur-sm rounded-lg border border-white/20">
