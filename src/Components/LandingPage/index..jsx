        ...
        <div>
            <div className=" grid grid-cols-2 mx-5">
                <div className="mt-20">
                    ...
                    <p className=" my-5">Welcome to <span className="text-[#8763CD] ">H-zombie </span> the ultimate platform where storytellers meet visionaries. Whether you're a scriptwriter crafting the next blockbuster or a producer seeking the perfect script, we bring your creative worlds together. Pitch ideas, find collaborators, and turn stories into screenplays!</p>
                    <Link to={"/signup"}>
                ...
                <div>
                    <img src="/landingpage.png" alt="scripts"
                        className="w-[800px] " />
                </div>
            </div>
            {/* cards */}
            <div className="grid grid-cols-3 gap-9 mx-4  mt-10">
            <div class="bg-white/25 shadow-lg p-5 backdrop-blur-sm rounded-lg border border-white/20 ">
